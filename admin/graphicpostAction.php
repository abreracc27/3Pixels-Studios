...
// Allow file formats
$allowTypes = array('JPG','jpg','PNG','png','JPEG','jpeg','GIF','gif','mp4');

// Max file size
$maxSize = 41943040; //40MB

// Set default redirect url
$redirectURL = 'list-graphic.php';
...
if(isset($_POST['imgSubmit'])){
	 ...
	 // Set redirect url
    $redirectURL = 'addEditgraphic.php';
    ...
    if((!empty($image['name']) && !empty($title)) || (!empty($id) && !empty($title))){
		...
		if(!empty($id)){
			...
			$prevData = $db->getRows('imggraphic', $conditions);
