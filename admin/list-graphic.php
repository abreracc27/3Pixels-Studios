...
<title>Manage Graphic Design | 3 Pixels Studios</title>
        ...
        <div class="col-lg-12 g-0">
            <form action="" method="post">
                <div id="datatable-container">
                    <span id="table-header-text">MANAGE GRAPHIC DESIGN</span>
                    <div id="top-line-divider2">
                        <a href="addEditgraphic.php" target="_blank"><input type="button" id="add-frm" value="NEW IMAGE"></a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a id="list-nav-btn" class="nav-link" href="graphicmedia.php">VIEW GRAPHIC MEDIA</a></li>
                        </ul>
                    </div> 
                        ...
                        <tbody>
                            ...
                            if(!empty($images)){
                                foreach($images as $row){
                                    $statusLink = ($row['status'] == 1)?'graphicpostAction.php?action_type=block&id='.$row['id']:'graphicpostAction.php?action_type=unblock&id='.$row['id'];
                                    $statusTooltip = ($row['status'] == 1)?'Click to Inactive':'Click to Active';
                            ?>
                            <tr>
                                <td id="data"><?php echo $row['id']; ?></td>
                                <td id="data"><img src="<?php echo '../uploads/imggraphic/'.$row['file_name']; ?>" alt="" /></td>
                                ...
                                <td id="data">
                                    <a href="addEditgraphic.php?id=<?php echo $row['id']; ?>" target="_blank"><input type="button" id="edit" value="EDIT"></a>
                                    ...
                                    <div class="modal-dialog"> 
                                        <div class="modal-content"> 
                                            ...
                                            <div class="modal-footer"> 
                                                <a href="graphicpostAction.php?action_type=delete&id=<?php echo $row['id']; ?>"><input type="button" id="reject" value="DELETE"></a>
                                            </div>                               
                                        </div> 
                                    </div>
                                </div>
                    ...
                    <div class="modal fade" id="modal_confirm" tabindex="-1"> 
						<div class="modal-dialog"> 
							<div class="modal-content"> 
								...
								<div class="modal-footer"> 
									<a href="controllerUserData.php?clear-graphic=1"><input type="button" id="clear" value="CLEAR"></a>
								</div> 								 
							</div> 
						</div>
					</div>
