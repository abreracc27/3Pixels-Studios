...
$images = $db->getRows('imggraphic', $condition);
?>
<?php echo file_get_contents("html/admin-header1.html"); ?>
<title>Graphic Design | 3Pixels Studios</title>
<?php echo file_get_contents("html/admin-header2.html"); ?>
<?php echo file_get_contents("html/admin-main-nav.html"); ?>
<div class="container-fluid">
	<div class="row my-3">
		<a href="list-graphic.php"><button id="manage-img" type="button">MANAGE GRAPHIC DESIGN</button></a>
	</div>
