...
$images = $db->getRows('imgportrait', $condition);
?>
<?php echo file_get_contents("html/admin-header1.html"); ?>
<title>Portrait Photography | 3Pixels Studios</title>
<?php echo file_get_contents("html/admin-header2.html"); ?>
<?php echo file_get_contents("html/admin-main-nav.html"); ?>
<div class="container-fluid">
	<div class="row my-3">
		<a href="list-portrait.php"><button id="manage-img" type="button">MANAGE PORTRAIT PHOTOGRAPHY</button></a>
	</div>
