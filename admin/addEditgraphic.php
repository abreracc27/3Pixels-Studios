...
if(!empty($_GET['id'])){
    ...
    $imgData = $db->getRows('imggraphic', $conditions);
}
...
<title>Add/Update Media | 3Pixels Studios</title>
...
<div class="frm-login" class="container-fluid">
    <form method="post" action="graphicpostAction.php" enctype="multipart/form-data">
        <div class="row">
            <div class="col-12 col-lg-12 order-lg-first mt-4">
                <span id="table-header-text">UPLOAD GRAPHIC MEDIA</span>
            ...
            <div class="col-12 col-lg-12">
                <?php if(!empty($imgData['file_name'])){ ?>
                    ...
                    <img id="img-update" src="../uploads/imggraphic/<?php echo $imgData['file_name']; ?>"> 
                <?php } ?>
            </div>
            ...
            <div class="col-12 col-lg-6 order-last offset-12 offset-lg-0 mt-3">
                <a href="list-graphic.php"><button type="button" id="upload-back">BACK</button></a>
            </div>
        </div>
    </form>
</div>
